                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('user.settings.update') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="contact" type="text" value="{{$user->contact}}" class="form-control @error('contact') is-invalid @enderror" name="contact" value="{{ old('contact') }}" required autocomplete="contact" autofocus>
                        ...
                        <div class="form-group row mb-0">
                            <div class="col-md-6 offset-md-4">
                                <button type="submit" class="btn btn-primary" onclick="return confirm('Do you Finally Want to Update your Details')">
                                    {{ __('Update') }}
                                </button>
                            </div>
                        </div>
